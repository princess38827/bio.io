...
Dataset and codebase for <a href="https://arxiv.org/abs/2402.18747">*Fine-Tuned Machine Translation Metrics Struggle in Unseen Domains*</a>
...
The dataset can be accessed <a href="https://github.com/amazon-science/bio-mqm-dataset/tree/main/data">here</a>.
...
This set of experiments might require an H100 for finetuning the 1.3B version of the NLLB model and for the evaluation of the baseline and finetuned models. The training and evaluation scripts follow similar patterns as the previous experiments.

```bash
# Prism adaptation experiments
./metrics_domain_adaptation/scripts/08-adapt_prism/01-finetune_prism.sh

# Evaluate adapted Prism models
./metrics_domain_adaptation/scripts/08-adapt_prism/02-eval_prism.sh
```
